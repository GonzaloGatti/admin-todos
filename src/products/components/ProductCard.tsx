...
import { addCookieCart, removeCookieCart } from "@/shoppping-cart/actions/actions";
...
export const ProductCard = ({ id, name, price, rating, image }: Props) => {
    ...
    return (
        <div className="bg-white shadow rounded-lg max-w-md dark:bg-gray-800 dark:border-gray-100">
